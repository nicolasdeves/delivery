        ...
        <div class="sidebar">
            <div class="categorias">
                ...
                <div class="botoes lora-font">
                    <a href="cardapio_burg.blade.php"><button><i class="fas fa-hamburger"></i>&nbsp;Burgs</button></a>
                    ...
                    <a href="cardapio_rango.blade.php"><button class="active"><i class="fa-solid fa-drumstick-bite"></i>&nbsp;Rangos</button></a>
                    <a href="cardapio_drink.blade.php"><button><i class="fa-solid fa-martini-glass-citrus"></i>&nbsp;Drinks</button></a>
                </div>
            </div>
        </div>
        <div class="content">
            <!--APAGAR DEPOIS DE PRONTO O PHP-->
