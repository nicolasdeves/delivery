        ...
        <div class="sidebar">
            <div class="categorias">
                ...
                <div class="botoes lora-font">
                    <a href="/cardapio/burger"><button><i class="fas fa-hamburger"></i>&nbsp;Burgs</button></a>
                    ...
                    <a href="#"><button class="active"><i class="fa-solid fa-drumstick-bite"></i>&nbsp;Rangos</button></a>
                    <a href="/cardapio/drink"><button><i class="fa-solid fa-martini-glass-citrus"></i>&nbsp;Drinks</button></a>
                </div>
            </div>
        </div>
        <div class="content">
